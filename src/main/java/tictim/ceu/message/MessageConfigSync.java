...
public class MessageConfigSync implements IMessage{
	...
	public enum Handler implements IMessageHandler<MessageConfigSync, IMessage>{
		INSTANCE;

		@Override public IMessage onMessage(MessageConfigSync message, MessageContext ctx){
