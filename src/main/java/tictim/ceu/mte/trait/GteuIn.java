...
public class GteuIn extends ConverterTrait implements IEnergyContainer{
	public <MTE extends MetaTileEntity & Converter> GteuIn(MTE mte){
		super(mte);
	}
	...
	@Override public boolean inputsEnergy(EnumFacing side){
		return metaTileEntity.getFrontFacing()!=side;
	}
